...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "433767c268a1d3", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "bca12b7bd31f8c", "SMTP password")
	flag.StringVar(
		&cfg.smtp.sender,
		"smtp-sender",
